...
=== RÚT TIỀN ===
Lệnh /rut [số tiền] hoặc /rut all — tối thiểu 100,000đ — cần đăng ký ngân hàng bằng /caidatbank — phí 1%.
...
const FALLBACK_FAQ: { patterns: RegExp[]; answer: string }[] = [
  ...
  { patterns: [/rút|rut tien/i], answer: "💸 Dùng lệnh /rut [số tiền] hoặc /rut all. Tối thiểu 100,000đ. Xử lý 5–30 phút." },
